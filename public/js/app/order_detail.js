        ...
        value: function render() {
            return React.createElement(
                ...
                this.props.details.map(function (item, index) {
                    return React.createElement(OrderDetail, { product: item, key: index });
                }),
                React.createElement(
                    'div',
...
var OrderDetailAddressClass = function (_React$Component2) {
    _inherits(OrderDetailAddressClass, _React$Component2);

    function OrderDetailAddressClass() {
        _classCallCheck(this, OrderDetailAddressClass);

        return _possibleConstructorReturn(this, (OrderDetailAddressClass.__proto__ || Object.getPrototypeOf(OrderDetailAddressClass)).apply(this, arguments));
    }

    _createClass(OrderDetailAddressClass, [{
        key: 'render',
        value: function render() {
            return React.createElement(
                'div',
                ...
                React.createElement(
                    ...
                    this.props.logistics_info.detail_desc
                )
            );
        }
    }]);

    return OrderDetailAddressClass;
}(React.Component);
...
var PayDetailClass = function (_React$Component3) {
    _inherits(PayDetailClass, _React$Component3);

    function PayDetailClass() {
        _classCallCheck(this, PayDetailClass);

        return _possibleConstructorReturn(this, (PayDetailClass.__proto__ || Object.getPrototypeOf(PayDetailClass)).apply(this, arguments));
    }
...
var OrderDetailClass = function (_React$Component4) {
    _inherits(OrderDetailClass, _React$Component4);

    function OrderDetailClass() {
        _classCallCheck(this, OrderDetailClass);

        return _possibleConstructorReturn(this, (OrderDetailClass.__proto__ || Object.getPrototypeOf(OrderDetailClass)).apply(this, arguments));
    }

    _createClass(OrderDetailClass, [{
        key: 'render',
        value: function render() {
            return React.createElement(
                'div',
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement('img', { src: this.props.products[this.props.product.product_id].img.location, alt: '' })
                    ),
                    React.createElement(
                        'div',
                        ...
                        React.createElement(
                            'p',
                            { className: 'p1' },
                            this.props.products[this.props.product.product_id].product_name
                        ),
                        React.createElement(
                            'p',
                            { className: 'p2' },
                            '\uFFE5 ',
                            this.props.products[this.props.product.product_id].product_sale_price
                        )
                    ),
                    React.createElement(
                        'div',
...
;
var ReduxIoIo = (0, _reactRedux.connect)(mapStateToProps)(IoIo);
var OrderDetailAddress = (0, _reactRedux.connect)(mapStateToProps)(OrderDetailAddressClass);
var PayDetail = (0, _reactRedux.connect)(mapStateToProps)(PayDetailClass);
var OrderDetail = (0, _reactRedux.connect)(mapStateToProps)(OrderDetailClass);
